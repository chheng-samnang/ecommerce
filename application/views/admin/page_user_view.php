                        ...
                        <tbody>
                            <?php $i=1; if(isset($tbl_body)){foreach($tbl_body as $body)
                            {
                                echo "<tr>";                                    
                                    ...
                                    echo "<td>";
                            ?>
                                     	<?php if(isset($action_url[3])){ ?><a href="<?php if(isset($action_url)){echo base_url($action_url[3]).'/'.$body[$j];}?>" class="btn btn-warning" style="margin-right:5px"><?php echo $this->lang->line('change_password')?></a><?php }?>
                                        <a href="<?php if(isset($action_url)){echo base_url($action_url[1]).'/'.$body[$j];}?>" class="btn btn-primary" style="margin-right:5px"><?php echo $this->lang->line('update')?></a>
                            <?php
                                    echo "</td>";                                    
                                echo "</tr>";
                            $i++;}}?>                            
