			...
			<div class="col-lg-12">				
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body" style=" line-height: 1.8;">
							 <div class="col-lg-3">
                                <img class="img-responsive img-thumbnail" style="width: 221.5px;" src="<?php echo base_url('assets/uploads/'.$detail->path);?>"/>
							...
							<div class="col-lg-9">
                                ...
                                <div class="col-lg-9"><?php echo $detail->str_name!=""?$detail->str_name:"No Stoer";?></div>
                                ...
                                <div class="col-lg-3"><b>Supplyer: </b></div>
                                <div class="col-lg-9"><?php echo $supplyer->mem_name;?></div>
                                <div class="col-lg-3"><b>Shop Owner: </b></div>
                                <div class="col-lg-9"><?php echo $detail->mem_name;?></div>    
