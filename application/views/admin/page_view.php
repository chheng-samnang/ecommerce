                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <tbody>
                            ...
                            ?>
                                        ...
                                        <?php if(isset($action_url[1])){ ?><a href="<?php if(isset($action_url)){echo base_url($action_url[1]).'/'.$body[$j];}?>" style="margin-right:5px" title="Edit"><i class="fa fa-pencil" style="font-size: 20px"></i></a><?php }?>
                                        <?php if(isset($action_url[2])){ ?><a href="<?php if(isset($action_url)){echo base_url($action_url[2]).'/'.$body[$j];}?>" class="btn btn-large confirModal del" title="Delete" data-confirm-title="Confirm Delete !" data-confirm-message="Are you sure you want to Delete this ?"><i class="fa fa-trash"  style="color: red; font-size: 20px"></i></a></a><?php }?>                                        
                            <?php
                                    echo "</td>";                                    
                                echo "</tr>";
                            $i++;}}?>                            
