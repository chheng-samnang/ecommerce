...
你在找什麼..." style="border-radius: 0px;" ng-model="searchBox">
        ...
        <div class="container-fluid" style="max-width: 87%;">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="<?php echo base_url('Home');?>">家</a></li>
                    <li>
                        <a href="<?php echo base_url('Product');?>">產品</span></a> 
                    </li>
                    <li ng-repeat="x in categories">
                        <a href="" ng-click="loadProduct_by_Cat(x.Id)">{{x.Cat_Name_ch}}</a>
                    </li>  
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo base_url('about');?>" >關於我們</a></li>
                    <li><a href="<?php echo base_url('contact');?>">
聯繫</a></li>
                    <li><a href="<?php echo base_url('blog');?>" target="blak"><span class="glyphicon glyphicon-user"></span> 博客</a></li>
                </ul>
            </div>
        </div><!-- /.container-fluid -->
    </nav>
