	...
	<div class="col-lg-6 col-lg-offset-3">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">Update Shop Info</h3>
			</div>
				...
				<form method="post" action="">
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								<input type="text" name="txt_shop_code" value="<?php echo $shop->str_code;?>"  class="form-control input-sm" placeholder="Input Your Shop Code">
							</div>
						</div>
						<div class="col-lg-6">
							<label>Shop Name</label>
							<div class="form-group">
								<input type="text" name="txt_shop_name" value="<?php echo $shop->str_name?>" class="form-control input-sm" placeholder="Input Your Shop Code">
							</div>
						</div>
					</div><!-- row -->
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								<input type="text" name="txt_shop_type" value="<?php echo $shop->str_type;?>" class="form-control input-sm" placeholder="Input Your Shop Code">
							</div>
						</div>
						<div class="col-lg-3">
						...
						<div class="col-lg-3">
							<a class="">
								<img src="<?php echo base_url('assets/uploads/'.$shop->str_img);?>" style="width: 60px">
							</a>
						</div>
					</div><!-- row -->
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea name="txt_Desc" class="form-control" cols="40" rows="6" ><?php echo $shop->str_desc?></textarea>
							</div>
						</div>
					</div>	
