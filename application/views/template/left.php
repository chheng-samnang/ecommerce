              ...
              <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse" id="navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>admin/Contact_us"><i class="fa fa-credit-card"></i> <?php echo $this->lang->line('contact');?></a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>admin/About"><i class="fa fa-history" aria-hidden="true"></i> <?php echo $this->lang->line('about');?></a>
                        </li>
                        <li>
